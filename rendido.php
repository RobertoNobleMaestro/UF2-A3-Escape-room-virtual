...
<body class="rendicion">
<img id="movimiento" src="img/large.jpeg" alt="Imagen en movimiento">
<div class="contenedor">
    <h1 class="muerto">¡HAS MUERTO!</h1>

        <p class="texto-maquina special-elite-regular"><p>Ya veo que has abandonado tu preciada<br>
